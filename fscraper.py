...
def banner():
    print(f"""
     _______ #      #       #       #       #       #       #       #
    (_______)#      #       #       #       #       #       #       #
     _____   #  ___ #  ____ #  ____ # _____ # ____  # _____ #  ____ #
    |  ___)  # /___)# / ___)# / ___)#(____ |#|  _ \ #| ___ |# / ___)#
    | |      #|___ |#( (___ #| |    #/ ___ |#| |_| |#| ____|#| |    #
    |_|      #(___/ # \____)#|_|    #\_____|#|  __/ #|_____)#|_|    #
             ##      ##       ##       ##       ##|_|    ##       ##       ##
...
def scrape():
    ...
    p = os.getcwd()
    bot = webdriver.Chrome(executable_path= p + "/chromedriver.exe", options=options)
